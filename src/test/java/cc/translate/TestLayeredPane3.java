...
public class TestLayeredPane3 {

    public static void main(String[] args) {
    	System.setProperty("java.net.useSystemProxies", "true");

        new TestLayeredPane3();
    }

    public TestLayeredPane3() {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                frame.pack();frame.getPreferredSize();
    ...
    public class TestPane extends JLayeredPane {
        ...
        public TestPane() {
            ...
            tp.getPreferredSize();
            overLayPane.getPreferredSize();
            RoundedPanel comp = new RoundedPanel();
			add(comp, new Integer(4));
