  ...
  public HtmlEditorKitTest()
  {
    SwingUtilities.invokeLater(new Runnable()
    {
      public void run()
      {
        ...
        styleSheet.addRule("body {position:relative;}");
        styleSheet.addRule("#close {width:20px;height:20px;position:absolute;top:0;right:0;color:#00ff00;}");

        // create some simple html as a string
        String htmlString = "<html>\n"
                          + "<body>\n"
                          + "<div id=\"close\">position!</div>\n"
                          + "<h1>Welcome!</h1>\n"
